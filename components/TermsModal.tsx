...
export const TermsModal = ({ open, setOpen }: Props) => {
  return (
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                <article className="prose-sm lg:prose">
                  <h2>MjengoSmart SaaS Terms & Conditions</h2>
                  <hr className="w-full" />
                  <h3>Terms and Conditions (&#34;Terms&#34;)</h3>
                  <p>
                    Our Terms and Conditions were last updated on 3rd January
                    2023.
                  </p>
                  ...
                  <ul>
                    <li>
                      <b>&#34;Affiliate&#34;</b> means an entity that controls,
                    ...
                    <li>
                      <b>&#34;Account&#34;</b> means a unique account created
                    ...
                    <li>
                      <b>&#34;Country&#34;</b> refers to{" "}
                      <span className="bg-yellow-100">KENYA</span>.
                    </li>
                    <li>
                      <b>&#34;Content&#34;</b> refers to content such as text,
                      images, or other information that can be posted, uploaded,
                      linked to or otherwise made available by You, regardless
                      of the form of that content.
                    </li>
                    <li>
                      <b>&#34;Device&#34;</b> means any device that can access
                      the Service such as a computer, a cell phone or a digital
                      tablet.
                    </li>
                    <li>
                      <b>&#34;Feedback&#34;</b> means feedback, innovations or
                    ...
                    <li>
                      ...
                      <span className="bg-yellow-100">MJENGO TECH WEBSITE</span>
                      , accessible from{" "}
                      <span className="bg-yellow-100">WWW.MJENGOSMART.COM</span>
                    </li>
                    <li>
                      <b>&#34;You&#34;</b> means the individual accessing or
                  ...
                  <ul>
                    ...
                    <li>
                      nfringing on any proprietary rights of any party,
                  ...
                  <p>
                    ...
                    is appropriate and complies with these Terms, refuse or
                  ...
                  <p>
                    ...
                    via email (
                    <span className="bg-yellow-100">MJENGOTECH@GMAIL.COM</span>)
