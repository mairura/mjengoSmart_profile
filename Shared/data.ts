...
export const carousel = [
  ...
  },
  {
    id: 5,
    heading:
      "Use Our project Cost Calculator to estimate the cost of Your Project",
    image_path: carousel5
  },
  {
    id: 6,
    heading:
      "Monitor Delivery and Usage of Construction Materials at the comfort of your Desk",
...
export const services = [
  {
    ...
    icon: "",
    description: "Real time update on your project progress on mobile and web",
  ...
  },
  {
    ...
    icon: "",
    description: "Get a Job at a construction sites with ease",
